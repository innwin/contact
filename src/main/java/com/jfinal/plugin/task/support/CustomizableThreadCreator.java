 ...
 * {@link com.jfinal.plugin.task.support.springframework.scheduling.concurrent.CustomizableThreadFactory}.
 *
 * @author Juergen Hoeller
 * @since 2.0.3
 * @see com.jfinal.plugin.task.support.springframework.scheduling.concurrent.CustomizableThreadFactory
 */
